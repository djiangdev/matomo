...
class __TwigTemplate_7a953fa0e91f6925bad9b9c5998b1f67be9cd593f0ff17f7dad9da1b327f2478 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"piwikTopControl\">
        ...
        // line 12
        if ((array_key_exists("container", $context) &&  !twig_test_empty((isset($context["container"]) || array_key_exists("container", $context) ? $context["container"] : (function () { throw new RuntimeError('Variable "container" does not exist.', 12, $this->source); })())))) {
            echo "container-name=\"";
...
{% endblock %}", "@TagManager/manageContainers.twig", "D:\\laragon\\www\\matomo\\plugins\\TagManager\\templates\\manageContainers.twig");
    }
}
