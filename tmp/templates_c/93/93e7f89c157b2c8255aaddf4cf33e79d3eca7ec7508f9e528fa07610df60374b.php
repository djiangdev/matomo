...
class __TwigTemplate_9ffb92779ba5762e1d10da2ed7ca91f3e563801df304d86be89805ca400accaa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <input type=\"hidden\" name=\"numMaxCustomVariables\"
           value=\"";
        // line 32
        echo \Piwik\piwik_escape_filter($this->env, (isset($context["maxCustomVariables"]) || array_key_exists("maxCustomVariables", $context) ? $context["maxCustomVariables"] : (function () { throw new RuntimeError('Variable "maxCustomVariables" does not exist.', 32, $this->source); })()), "html_attr");
        echo "\">
...
<div
    ...
    default-site=\"";
        // line 36
        echo \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["defaultSiteDecoded"]) || array_key_exists("defaultSiteDecoded", $context) ? $context["defaultSiteDecoded"] : (function () { throw new RuntimeError('Variable "defaultSiteDecoded" does not exist.', 36, $this->source); })())), "html_attr");
        echo "\"
    max-custom-variables=\"";
        // line 37
        echo \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["maxCustomVariables"]) || array_key_exists("maxCustomVariables", $context) ? $context["maxCustomVariables"] : (function () { throw new RuntimeError('Variable "maxCustomVariables" does not exist.', 37, $this->source); })())), "html_attr");
        echo "\"
    server-side-do-not-track-enabled=\"";
        // line 38
        echo \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["serverSideDoNotTrackEnabled"]) || array_key_exists("serverSideDoNotTrackEnabled", $context) ? $context["serverSideDoNotTrackEnabled"] : (function () { throw new RuntimeError('Variable "serverSideDoNotTrackEnabled" does not exist.', 38, $this->source); })())), "html_attr");
        echo "\"
></div>
...
<div
    ...
    default-site=\"";
        // line 43
        echo \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["defaultSiteDecoded"]) || array_key_exists("defaultSiteDecoded", $context) ? $context["defaultSiteDecoded"] : (function () { throw new RuntimeError('Variable "defaultSiteDecoded" does not exist.', 43, $this->source); })())), "html_attr");
        echo "\"
></div>
...
";
    ...
    {
        return array (  196 => 66,  189 => 62,  185 => 61,  179 => 58,  175 => 57,  169 => 54,  165 => 53,  158 => 49,  152 => 46,  146 => 43,  138 => 38,  134 => 37,  130 => 36,  123 => 32,  115 => 27,  111 => 26,  107 => 25,  103 => 24,  99 => 23,  95 => 22,  91 => 21,  87 => 20,  81 => 17,  75 => 16,  68 => 11,  64 => 10,  56 => 4,  52 => 3,  47 => 1,  43 => 8,  36 => 1,);
    }
...
{% endblock %}
", "@CoreAdminHome/trackingCodeGenerator.twig", "D:\\laragon\\www\\matomo\\plugins\\CoreAdminHome\\templates\\trackingCodeGenerator.twig");
    }
}
