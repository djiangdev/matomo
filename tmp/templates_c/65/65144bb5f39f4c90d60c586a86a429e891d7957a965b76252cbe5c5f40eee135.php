...
class __TwigTemplate_04f8663491300a97cd201bef5180ed1d8f8f685da60767527be02683e1b16257 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 10
        echo "    ";
        $context["topMenuAction"] = ((array_key_exists("tagAction", $context)) ? (_twig_default_filter((isset($context["tagAction"]) || array_key_exists("tagAction", $context) ? $context["tagAction"] : (function () { throw new RuntimeError('Variable "tagAction" does not exist.', 10, $this->source); })()), "")) : (""));
        // line 11
        echo "    ";
        echo $this->env->getFunction('postEvent')->getCallable()("Template.header", "tagmanager");
        echo "
    ";
        // line 12
    ...
    ";
        // line 13
        echo $this->env->getFunction('postEvent')->getCallable()("Template.footer", "tagmanager");
        echo "
";
    }
...
<div class=\"page\">
    ...
    ";
        // line 42
        if (( !array_key_exists("showMenu", $context) || (isset($context["showMenu"]) || array_key_exists("showMenu", $context) ? $context["showMenu"] : (function () { throw new RuntimeError('Variable "showMenu" does not exist.', 42, $this->source); })()))) {
            // line 43
            echo "        ";
...
";
    ...
    public function block_topcontrols($context, array $blocks = [])
    {
        ...
        // line 29
        if ((array_key_exists("container", $context) &&  !twig_test_empty((isset($context["container"]) || array_key_exists("container", $context) ? $context["container"] : (function () { throw new RuntimeError('Variable "container" does not exist.', 29, $this->source); })())))) {
            echo "container-name=\"";
...
{% endblock %}
", "@TagManager/tagmanager.twig", "D:\\laragon\\www\\matomo\\plugins\\TagManager\\templates\\tagmanager.twig");
    }
}
